...
export default function AdminSupportInboxPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f6f9] text-slate-900">
      <header className="border-b border-slate-200 bg-[#00305C] text-white">
                ...
                <li key={thread.id}>
                  <button
                    ...
                    className={cn(
                      ...
                      selectedId === thread.id && 'bg-[#213D59]/5',
                    )}
                  >
                    <div className="flex items-center justify-between gap-2">
                      ...
                      {thread.unread > 0 ? (
                        <span className="rounded-full bg-[#213D59] px-2 py-0.5 text-[10px] font-bold text-white">
                          {thread.unread}
                        </span>
                      ) : null}
                    </div>
        ...
        <section className="flex min-h-[70vh] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          {!selectedId ? (
            ...
            <>
              ...
              <div
                ref={scrollerRef}
                className="flex-1 space-y-3 overflow-y-auto bg-[#f5f8fc] px-4 py-4"
              >
                      ...
                      >
                        <div
                          className={cn(
                            ...
                            isAdmin
                              ? 'rounded-br-md bg-[#213D59] text-white'
                              : isOwner
              ...
              >
                <div className="flex items-end gap-2 rounded-2xl border border-slate-200 bg-white px-2 py-2">
                  ...
                  <button
                    ...
                    className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#213D59] text-white disabled:opacity-50"
