    ...
    return (
      <div className="grid min-h-[100dvh] place-items-center bg-[#f6f8fb] px-5">
        <div className="text-center">
          ...
          <Button
            onClick={onBack}
            className="mt-4 w-auto rounded-xl bg-[#213D59]"
          >
                    ...
                    <div className="px-4 py-3.5">
                      {hasData ? (
                        Array.isArray(subsectionData) ? (
                          ...
                          <p className="text-sm text-[#213D59]">
          ...
          <div className="space-y-4">
            <div className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200/80">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-semibold tabular-nums text-[#213D59]">
          ...
          <div className="fixed inset-x-3 bottom-[calc(4.75rem+env(safe-area-inset-bottom))] z-[70] overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-slate-200 md:hidden">
            {onOwnerLetterAccess ? (
              <button
                ...
                className="flex w-full items-center gap-3 border-b border-slate-100 px-4 py-3.5 text-left text-[14px] font-medium text-[#213D59]"
              >
