...
export default function Section14InvestmentAccounts({
  ...
  const multiItemAutofill = useAiMultiItemAutofill({
    ...
    setAiNotice,
    describeFields: ['financial_institution', 'account_type', 'account_number'],
    isDuplicate: investmentAccountsAreDuplicates,
    conflictMode: 'ask',
  ...
  const handleDocumentUpload = async (file?: File | null,
    ...
    try {
      ...
      const uploaded = await uploadAIDocument(file, { section: '14' });
