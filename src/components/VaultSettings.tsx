      ...
      <div className="rounded-3xl border bg-white p-4 shadow-sm sm:p-8 md:p-10">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
          <button
            ...
            className={cn(
              'w-full rounded-xl px-6 py-3.5 text-xs font-black uppercase sm:w-auto sm:px-10 sm:py-4',
              disableActions
          ...
          {billing.status === 'active' && (
            <button
              ...
              className="w-full rounded-xl bg-amber-600 px-6 py-3 text-xs font-black text-white sm:w-auto"
            >
              Pause Subscription
            </button>
          )}
          ...
          <button
            ...
            className="w-full rounded-xl bg-slate-800 px-6 py-3 text-xs font-black text-white sm:w-auto"
          >
            Manage Billing
          </button>
        </div>
